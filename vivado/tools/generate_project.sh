...
if [ "$ARG_RUN" == "gen_synth" ]; then
	...
	if [ "$ARG_SWITCH" == "vta" ]; then
		...
		echo "add_cells_to_pblock pblock_VTA_HLS [get_cells [list fpga/core_inst/vivado_block_design_inst/VTA_HLS]] -clear_locs"
		echo "endgroup"
	fi
	echo "startgroup "
	...
	echo "endgroup"
	echo "startgroup"
	echo "add_cells_to_pblock pblock_1 [get_cells [list fpga/core_inst/vivado_block_design_inst/xlconcat_0 fpga/core_inst/vivado_block_design_inst/zynq_ultra_ps_e_0 nolabel_line875 nvmetop_inst pcie_us_axi_dma_inst pcie_us_axi_master_inst pcie_us_axil_master_inst pcie_us_axil_master_inst_0 pcie_us_cfg_inst pcie_us_msi_inst rc_reg status_error_cor_pm_inst status_error_uncor_pm_inst dbg_hub pcie4_uscale_plus_inst]] -clear_locs"
	echo "endgroup"
	echo "startgroup"
	echo "add_cells_to_pblock pblock_1 [get_cells [list fpga/core_inst/vivado_block_design_inst/*]] -add_primitives -clear_locs"
	echo "endgroup"
	echo "startgroup"
	echo "add_cells_to_pblock pblock_1 [get_cells [list fpga/core_inst/cc_mux_inst cq_demux_inst]] -clear_locs"
	echo "endgroup"
	echo "startgroup"
	echo "add_cells_to_pblock pblock_1 [get_cells [list fpga/core_inst/vivado_block_design_inst/axi_gpio_0 fpga/core_inst/vivado_block_design_inst/axi_gpio_1 fpga/core_inst/vivado_block_design_inst/axi_gpio_2 fpga/core_inst/vivado_block_design_inst/axi_interconnect_4 fpga/core_inst/vivado_block_design_inst/axi_interconnect_0 fpga/core_inst/vivado_block_design_inst/axi_interconnect_1 fpga/core_inst/vivado_block_design_inst/axi_interconnect_2 fpga/core_inst/vivado_block_design_inst/axi_interconnect_3 fpga/core_inst/vivado_block_design_inst/axi_protocol_convert_0 fpga/core_inst/vivado_block_design_inst/axi_protocol_convert_1 fpga/core_inst/vivado_block_design_inst/axi_protocol_convert_2 fpga/core_inst/vivado_block_design_inst/axi_uartlite_0 fpga/core_inst/vivado_block_design_inst/axi_uartlite_1 fpga/core_inst/vivado_block_design_inst/xlconstant_0 fpga/core_inst/vivado_block_design_inst/ila_0 fpga/core_inst/vivado_block_design_inst/ila_1 axi_ram_inst fpga/core_inst/vivado_block_design_inst/proc_sys_reset_0 fpga/core_inst/vivado_block_design_inst/proc_sys_reset_1 fpga/core_inst/vivado_block_design_inst/system_management_wiz_0]] -clear_locs"
	echo "endgroup"
